...
//       expect(config)
//         .toEqual(clone);
//       expect(CONFIG_STACK.length)
//         .toEqual(configStackSize + 1);
//     });
//     it('should add non-existing key-value pair', () => {
//       const configStackSize = CONFIG_STACK.length;
//       pushConfig({ pushConfigTest: 'qwer' });
//       expect(config.pushConfigTest)
//         .toEqual('qwer');
//       expect(CONFIG_STACK.length)
//         .toEqual(configStackSize + 1);
//     });
...
//       expect(config.backendConfigFile)
//         .toEqual('qwer');
//       expect(CONFIG_STACK.length)
//         .toEqual(configStackSize + 1);
//     });
...
//       expect(config.updateConfigTest)
//         .toEqual('asdf');
//       expect(CONFIG_STACK.length)
//         .toEqual(configStackSize);
//     });
